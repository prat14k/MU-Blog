...
ctx.fillText("Puzzle "+untangleGame.currentLevel+", Completeness:" + untangleGame.progressPercentage + "%", 40,ctx.canvas.height-25);
	//setupCurrentLevel();
}
